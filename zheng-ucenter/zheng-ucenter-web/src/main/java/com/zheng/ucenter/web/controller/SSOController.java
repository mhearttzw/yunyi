...
import com.zheng.upms.common.constant.UcenterResult;
import com.zheng.upms.common.constant.UcenterResultConstant;
...
public class SSOController extends BaseController {
    ...
    public Object login(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        if (StringUtils.isBlank(username)) {
            return new UcenterResult<String>(UcenterResultConstant.EMPTY_USERNAME, "帐号不能为空！");
        }
        if (StringUtils.isBlank(password)) {
            return new UcenterResult<String>(UcenterResultConstant.EMPTY_PASSWORD, "密码不能为空！");
        }
        Subject subject = SecurityUtils.getSubject();
        Session session = subject.getSession();
        ...
        if (StringUtils.isBlank(hasCode)) {
            ...
            try {
                ...
                return new UcenterResult(UcenterResultConstant.INVALID_USERNAME, "帐号不存在！");
            } catch (IncorrectCredentialsException e) {
                return new UcenterResult(UcenterResultConstant.INVALID_PASSWORD, "密码错误！");
            } catch (LockedAccountException e) {
                return new UcenterResult(UcenterResultConstant.INVALID_ACCOUNT, "帐号已锁定！");
            }
            // 更新session状态
        ...
        if (StringUtils.isBlank(backurl)) {
            ...
            return new UcenterResult(UcenterResultConstant.SUCCESS, backurl);
        } else {
            return new UcenterResult(UcenterResultConstant.SUCCESS, backurl);
        }
    }*/
    ...
    public Object code(HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(codeParam) || !codeParam.equals(code)) {
            new UcenterResult(UcenterResultConstant.FAILED, "无效code");
        }
        return new UcenterResult(UcenterResultConstant.SUCCESS, code);
    }
